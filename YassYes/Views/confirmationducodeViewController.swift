//
//  confirmationducodeViewController.swift
//  YassYes
//
...
class confirmationducodeViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func confirmVerif(_ sender: Any) {
      ...
      //  let user = userModel(_id:"",nom: "", prenom: "", email: "", password: "",gender: "", age: "", weight: "", height: "",   experience: "", goal: "", token: "")
        ...
        APIManger.shareInstence.verifyCode(_id: _id, code: code, completionHandler: {
            (isSuccess) in
            if isSuccess{
                self.performSegue(withIdentifier: "nouveauMotDePasse", sender: nil)
            }
            else
